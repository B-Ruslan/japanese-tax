        ...
        <>
            ...
            <div className="header">
                <p>
                    ...
                    So, this simple tool allows you to calculate how much taxes you would pay after landing a nice gig in the country. 
                </p>
                <span className="headerSpan">
                However, this website is created for reference only.
